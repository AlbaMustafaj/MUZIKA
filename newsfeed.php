...
<body style="background-image: url('images/bg.png'); background-attachment: fixed;" >
	...
	?>
	<nav class="navbar navbar-inverse" style="background-color:#663366">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img src="images/icon40.png"/></a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-left" >
					<!--<li class="active"><a href="index.html">Home</a></li>-->
					<li><a href="index.html"><div style="color:white;">Home</div></a></li>
					<li><a href="#"><div style="color:white;">Sign Up Artist</div></a></li>
					<li><a href="#"><div style="color:white;">Profile</div></a></li>
					<li><a href="#"><div style="color:white;"></div></a></li>
					<li><a href="#"><div style="color:white;">Profile Artist</div></a></li>
					<li><a href="#"><div style="color:white;">More</div></a></li>
				</ul>
	...
	<script type="text/javascript">
		function makeComment(ID, commenter_ID, post_date) {
        	...
        	alert("done3");
          	...
          	alert("done4");
          	document.getElementById(input2).innerHTML = "asd";
            }
        };
