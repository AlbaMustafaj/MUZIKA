		...
		<nav class="navbar navbar-inverse" style="background-color:#663366">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php"><img src="images/icon40.png"/></a>
				</div>
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav" >
						<!--<li class="active"><a href="index.html">Home</a></li>-->
						<li><a href="index.php"><div style="color:white;">Home</div></a></li>
						<li><a href="signup.php"><div style="color:white;">Sign Up</div></a></li>
					</ul>
				</div>
			</div>
		</nav>
